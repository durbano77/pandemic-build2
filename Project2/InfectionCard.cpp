...
InfectionCard::InfectionCard(City* theCity, CString title, CString cardtextfront, CString cardtextback) {
	city = theCity;
	card_name = title;
  color = cardtextfront;
...
CString InfectionCard::getColor() const{
    return color;
}


void InfectionCard::Infect(int* remainingDiseaseCubes, bool* isEradicated, City* theCity, CString color) {
